  ...
  return (
    <SafeAreaView style={{ flex: 1 }} >
      <View style={styles.container}>
        ...
        <Image style={styles.pointImage} source={{ uri: 'https://images.unsplash.com/photo-1542838132-92c53300491e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=600&q=72'}} />

        <Text style={styles.pointName}>Mercado do seu Ze</Text>
